...
<head>
    ...
    <style>
        ...
        .card-body {
            ...
            bottom: 0;
            width: 100%;
            background: rgba(255, 255, 255, 0.6); /* Latar belakang putih transparan */
            padding: 10px;
            text-align: center;
        }
        ...
        .card-title {
            ...
            font-weight: bold;
            color: #333;
            text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.3); /* Agar tulisan lebih jelas */
        }
...
<body>
    ...
    <script>
        ...
        function selectMenuItem(menuItem, id, name, price) {
            // Menambahkan kelas aktif ke menu item yang dipilih
            const allMenuItems = document.querySelectorAll('.menu-item');
            allMenuItems.forEach(item => item.classList.remove('active')); // Hapus kelas aktif dari semua item
            menuItem.classList.add('active'); // Tambahkan kelas aktif ke item yang dipilih
        ...
        renderMenu(); // Inisialisasi menu pertama kali
    </script>
